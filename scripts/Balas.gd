#Codigo creado por Jesús Alejandro Valdés Viramontes
...
# Codigo que se ejecuta al aparecer la bala
func _ready() -> void:
	# Configuración de un nuevo temporizador para eliminar la bala después de un tiempo
	var timer = Timer.new()
